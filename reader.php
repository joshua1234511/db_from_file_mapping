            ...
            if ($countOwlnav != 0 && $RowOwlnav[0] != '' && $countOwlnav < 2) {
                ...
                foreach ($ReaderOwlSharesTest as $RowOwlSharesTest) {
                    if ($countOwlSharesTest != 0 && $RowOwlSharesTest[0] != '' && $countOwlSharesTest < 2) {
                        ...
                        $tickers                             = "";
                        $no_of_holdings                      = 0; //calc on Update
                        ...
                        $nav_high                            = 0; //calc on Update
                        $nav_low                             = 0; //calc on Update
                        $mp_high                             = 0; //calc on Update
                        $mp_low                              = 0; //calc on Update
                        $total_period_days                   = 0; //calc on Update
                        $nav_days                            = 0; //calc on Update
                        $premium_days                        = 0; //calc on Update
                        $discount_days                       = 0; //calc on Update
